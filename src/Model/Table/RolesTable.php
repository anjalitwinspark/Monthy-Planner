 ...
 * Roles Model
 *
 * @property \App\Model\Table\ExpenseFieldsTable|\Cake\ORM\Association\HasMany $ExpenseFields
 * @property \App\Model\Table\IncomeFieldsTable|\Cake\ORM\Association\HasMany $IncomeFields
...
class RolesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('ExpenseFields', [
            'foreignKey' => 'role_id'
        ]);
        $this->hasMany('IncomeFields', [
            'foreignKey' => 'role_id'
        ]);
        $this->hasMany('Users', [
            'foreignKey' => 'role_id'
